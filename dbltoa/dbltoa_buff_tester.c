...
/*   Updated: 2025/03/12 14:47:10 by rde-brui      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static void		double_tests_b(void);
static void		edgecase_tests_b(void);
static void		random_tests_b(void);
static void		linear_range_tests_b(void);
static void		power_of_ten_tests_b(void);
static void		subnormal_to_max_tests_b(void);
static void		negative_power_of_ten_tests_b(void);
...
static void	varies_buff_size(void)
{
